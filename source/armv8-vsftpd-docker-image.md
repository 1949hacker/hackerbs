因客户使用飞腾 2000 平台需要部署 vsftpd，但因系统环境不同存在诸多部署问题，且无适配的 armv8 版本 vsftpd 容器，特此专门构建 vsftpd 镜像并记录构建过程。
...
git 仓库地址：[https://github.com/1949hacker/vsftpd](https://github.com/1949hacker/vsftpd)
